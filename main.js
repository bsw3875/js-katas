...
for (counter5 = 1; counter5 < 10; counter5++) {
...
for (counter8 = 20; counter8 >= 1; counter8 -= 3) {
...
for (let index = 0, sum = 0; index < sampleArr.length; sum += sampleArr[index++]) {
